...
void saveimage_pgm(char *filename,short**image,int h,int w,int scale=1);
void saveimage_pgm(char *filename,short*image,int h,int w,int scale=1);
...
int qx_image_size(char* file_name,int &h,int &w);/*return # of channel*/
float qx_image_max_value(char* filename);/*return maximum value*/
/*load image*/
int qx_loadimage(char*file_name,unsigned char*image,int h,int w,int *nr_channel=NULL);
int qx_loadimage(char*file_name,char*image,int h,int w,int *nr_channel=NULL);
...
void qx_saveimage(char*file_name,char*image,int h,int w,int channel);
